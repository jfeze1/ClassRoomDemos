        ...
        protected void SearchProduct_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //Single record data is check against null
                    //Multi-record data is check against .Count
                    if (info == null)
                    {
                        //The product was not found.
                        //Message to the user
                        //refresh the incorrect drowpdownList to reflect the accurate current product list
