...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:DropDownList ID="CategoryList" runat="server" 
            ...
            <asp:ListItem Value="0">Select ...</asp:ListItem> <%--use dropdown List task to set this (the arrow at the beginning of the controller--%>
        </asp:DropDownList>
        &nbsp;&nbsp;
        ...
        <asp:GridView ID="ProductList" runat="server" AutoGenerateColumns="False" DataSourceID="ProductListODS" AllowPaging="True" PageSize="5">
            <Columns>
                <asp:TemplateField HeaderText="ID" SortExpression="ProductID">
                    <ItemTemplate> <%--ItemTemplate is read only--%>
    ...
    <asp:ObjectDataSource ID="SupplierIDListODS" runat="server" 
        OldValuesParameterFormatString="original_{0}" 
